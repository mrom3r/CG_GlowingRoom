...
RenderingManager::RenderingManager() : model(glm::mat4(1.0f)) {}

RenderingManager::~RenderingManager() = default;

void RenderingManager::InitializeVAO() {
    glGenVertexArrays(1, &VertexArrayID);
}

void RenderingManager::SetVertices(std::vector<glm::vec3> vertices) {
...
void RenderingManager::SetNormals(std::vector<glm::vec3> normals) {
    glBindVertexArray(VertexArrayID);
...
void RenderingManager::SetTexture(std::vector<glm::vec2> uvBufferData, GLubyte textureData[]) {
...
void RenderingManager::SetTexture(std::vector<glm::vec2> uvBufferData, const std::string &bmpPath) {
    glGenTextures(1, &texID);
...
void RenderingManager::DrawObject() const {
...
std::vector<glm::vec3> RenderingManager::getTriangleNormals(Point vertex, const std::vector<Triangle> &triangles) {
...
glm::vec3 RenderingManager::calculateMeanVector(const std::vector<glm::vec3> &vector) {
    glm::vec3 mean = {0, 0, 0};
...
void RenderingManager::computeTrianglesVertices(std::vector<glm::vec3> &vertices, std::vector<glm::vec3> &normals) {
